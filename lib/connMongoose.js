...
const mongoDBUser = (process.env.NODEPOP_MONGODB_USER || '');
const mongoDBPass = (process.env.NODEPOP_MONGODB_PASSWORD || '');
...
mongoose.connect(`mongodb://${mongoDBHost}${mongoDBPort}/nodepop`, {
    useMongoClient: true,
    user: mongoDBUser,
    pass: mongoDBPass
});
